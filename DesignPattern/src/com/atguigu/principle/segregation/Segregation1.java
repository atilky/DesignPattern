...
class B implements Interface1{
    ...
    @Override
    public void operation4() {  System.out.println("B 實現 operation4");}

    @Override
    public void operation5() {  System.out.println("B 實現 operation5");}
}
...
class D implements Interface1{
    ...
    @Override
    public void operation2() {  System.out.println("D 實現 operation2"); }

    @Override
    public void operation3() {  System.out.println("D 實現 operation3");}
...
/**
 * A類 通過接口Interface1 依賴(使用)B類,但是只會用到1,2,3方法
 */
class A{
...
/**
 * C類 通過接口Interface1 依賴(使用)D類,但是只會用到1,4,5方法
 */
class C{
    public void depend1(Interface1 i){
        i.operation1();
